...
default_source_schema = "GFTTEST5"
...
def get_dbt_params(**kwargs):
    ...
    source_schema = params.get("source_schema", default_source_schema)
    if close_date:
...
with DAG(
    ...
    description='Runs Credit Statement Generation.',
    ...
    # Uploads to: s3://statements-credit-lending-perf/ (test bucket)
    # Batch size: 10000 accounts per archive
    export_statements_to_s3 = SnowflakeOperator(
        ...
        sql="""
            CALL public.sp_export_statements_to_s3(
                ...
                'dm',
                'STATEMENT_STAGE',
                'statements-credit-lending-perf',
                50000
            );
        """,
    ...
    # NOTE: For production, change bucket and batch size:
    # 'statements-credit-pd', 50000
