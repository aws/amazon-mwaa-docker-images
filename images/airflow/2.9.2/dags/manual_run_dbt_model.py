...
with DAG(
    ...
    run_one_model = DbtRunOperator(
        ...
        vars={"batch_id": batch_id, "include_schema_list":include_schema_list, "exclude_schema_list":exclude_schema_list, "target_schema":target_schema, "start_date": start_date, "end_date":end_date, "is_full_load_run":is_full_load_run, "is_first_time_run":is_first_time_run},
        dag=dag,
        priority_weight = 4
   )
