...
ACCOUNT_ID="942136460468" # Put your account ID here.
ENV_NAME="Galileo-RAD" # Choose an environment name here.
REGION="us-east-1" # Keeping the region us-west-2 as default.
