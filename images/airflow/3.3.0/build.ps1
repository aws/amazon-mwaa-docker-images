...
<#
.SYNOPSIS
    Builds the Amazon MWAA Airflow 3.3.0 Docker images on Windows.
...
# Build base image
# ---------------------------------------------------------------------------
& $ContainerRuntime build -f .\Dockerfiles\Dockerfile.base -t localhost/amazon-mwaa-docker-images/airflow:3.3.0-base .\
